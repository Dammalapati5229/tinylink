...
export const getServerSideProps: GetServerSideProps<Props> = async (ctx) => {
  ...
  const createdAtFormatted = new Date(link.created_at).toISOString();
  const lastClickedFormatted = link.last_clicked_at
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ marginBottom: "8px" }}>
          <strong>Last clicked:</strong> {lastClickedFormatted}
        </p>
        <p style={{ marginBottom: "8px" }}>
